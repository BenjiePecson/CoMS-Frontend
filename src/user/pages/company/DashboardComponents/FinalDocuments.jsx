      ...
      <div className="flex flex-row justify-between m-1">
        ...
        <div className="modal" role="dialog">
          <div className="modal-box">
            <h3 className="text-lg font-bold">Upload Final Documents</h3>
            <div className="flex flex-col">
              <label className="form-control w-full">
                ...
                <select className="select select-bordered">
                  <option>SEC Certificates</option>
                  <option>Articles of Incorporation</option>
                  <option>ByLaws</option>
                  <option>BIR/COR</option>
                  <option>LGU Business Permit</option>
                </select>
              </label>
            ...
            <div className="flex justify-center mt-3">
              <button className="btn my-3 mx-3">Submit</button>
              <button className="btn my-3">Close</button>
            </div>
          </div>
