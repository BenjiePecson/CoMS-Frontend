...
export const ViewQuote = () => {
  ...
  const handleOnChange = (e) => {
    ...
    setFormSelectedData({ ...formSelectedData, [name]: value });
  };
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col w-full items-center justify-center gap-2">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-2">
                  <label className="form-control w-full">
                    ...
                    <input
                      ...
                      value={formSelectedData.recipient_company}
                  ...
                  <label className="form-control w-full">
                    ...
                    <input
                      ...
                      className="input input-bordered w-full"
                      name="recipient_name"
                      value={formSelectedData.recipient_name}
                      onChange={handleOnChange}
                    />
                  </label>
                  <label className="form-control w-full">
                    ...
                    <input
                      type="text"
                      placeholder="Enter a recipient email"
                      className="input input-bordered w-full"
                      name="recipient_email"
                      value={formSelectedData.recipient_email}
                      onChange={handleOnChange}
                    />
                  </label>
                  <label className="form-control w-full">
                    ...
                    <input
                      ...
                      value={formSelectedData.recipient_address}
                      onChange={handleOnChange}
                    />
                  </label>
                  <label className="form-control w-full">
                    ...
                    <select
                      ...
                      name="currency"
                      value={formSelectedData.currency}
                      onChange={handleOnChange}
                    >
                  ...
                  <label className="form-control w-full">
                    ...
                    <select
                      ...
                      value={formSelectedData.billing_account}
                      onChange={handleOnChange}
                    >
                  ...
                  <label className="form-control w-full">
                    ...
                    <input
                      ...
                      className="input input-bordered w-full"
                      name="due_date"
                      value={formSelectedData.due_date}
                      onChange={handleOnChange}
                    />
                  </label>
                </div>
                ...
                <div className="w-full">
                  ...
                  <label className="form-control w-full">
                    ...
                    <input
                      ...
                      className="input input-bordered w-full"
                      name="service_type"
                      value={formSelectedData.service_type}
                      onChange={handleOnChange}
                    />
                  </label>
                  <div className="divider"></div>
                ...
                <div className="w-full">
                  <div className="flex flex-row w-full items-end gap-2">
                    <label className="form-control w-full">
                      ...
                      <input
                        type="text"
                        placeholder="Enter a scope of work"
                        className="input input-bordered w-full"
                        name="task"
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (selectedScope != -1) {
                          let updatedScope = formSelectedData.scope_of_work.map(
                            (scope, index) => {
                          ...
                          let newScope = [
                            ...formSelectedData.scope_of_work,
                            scopeData,
                          ];
                          setFormSelectedData({
                            ...formSelectedData,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full">
                  ...
                  <label className="form-control w-full">
                    <div className="label w-full">
                      <span className="label-text">OOP Expenses</span>
                    </div>
                    <input
                      type="text"
                      className="input input-bordered w-full"
                ...
                <div className="flex flex-col w-full py-5">
                  {formSelectedData.scope_of_work.map((scope, index) => {
                    let service_fee = formatNumberWithCommaAndDecimal(
                      scope.service_fee
                    );

                    let display_service_fee =
                      formSelectedData.currency == "USD"
                        ? `${service_fee} USD`
                        : `PHP ${service_fee} + 12% VAT`;
                      ...
                      >
                        ...
                        <div className="flex flex-row gap-2">
                          ...
                          <button
                            ...
                            onClick={() => {
                              let newScopes =
                                formSelectedData.scope_of_work.filter(
                                  (_, idx) => index != idx
                                );

                              setFormSelectedData({
                                ...formSelectedData,
                                scope_of_work: newScopes,
                              });
                            }}
                          >
                            <svg
