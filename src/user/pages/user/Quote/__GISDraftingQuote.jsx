...
export const GISDraftingQuote = ({ selectedDocument }) => {
  ...
  return (
    <>
      <div className="divider">GIS Drafting</div>
      <form
      ...
      >
        ...
        <label htmlFor="recipient_email" className="form-control">
          <div className="label">
        ...
        <label htmlFor="recipient_position" className="form-control">
          <div className="label">
        ...
        <label htmlFor="due_date" className="form-control">
          ...
          <input
            ...
            value={data.due_date}
            onChange={handleOnChange}
            className="input input-bordered w-full lg:w-[125%] 2xl:w-full"
            required
          />
        </label>
